                                            ...
                                            uint16_t Length)
{
   ...
   status = HAL_I2C_Mem_Write(i2c_handler, i2cAddr, address, addressSize, Buffer, Length, 1000);

    /* Check the communication status */
    if (status != HAL_OK)
    {
        /* Re-Initiaize the I2C Bus */
        I2Cx_Error(i2c_handler, i2cAddr);
    }
    return status;
}
...
/**
  ...
  * @retval None
  */
void TS_IO_Write(uint8_t i2cAddr, uint16_t address, void *data, size_t length)
{
    I2Cx_WriteMultiple(&hi2c2, i2cAddr, address, I2C_MEMADD_SIZE_16BIT,  (uint8_t*)data, length);
